...
public class PaperDeliveryMenu : IMenu
{
    ...
    /// </summary>
    public PaperDeliveryMenu() : this(new ConsoleSetting())
    {
    ...
    public PaperDeliveryMenu(IConsoleSetting consoleSetting)
    {
        IMenuContent content = new PaperDeliveryMenuContent();
        CaptionItems = content.CaptionItems;
        MenuItems = content.MenuItems;
        StatusItems = content.StatusItems;

        IMenuBehavior behavior = new PaperDeliveryMenuBehavior();
