...
public class PaperDeliveryContractorMenu : IMenu
{
    ...
    /// </summary>
    public PaperDeliveryContractorMenu() : this(new ConsoleSetting())
    {
    ...
    public PaperDeliveryContractorMenu(IConsoleSetting consoleSetting)
    {
        IMenuContent content = new PaperDeliveryContractorMenuContent();
        CaptionItems = content.CaptionItems;
        MenuItems = content.MenuItems;
        StatusItems = content.StatusItems;

        IMenuBehavior behavior = new PaperDeliveryContractorMenuBehavior();
